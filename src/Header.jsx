...
function Header(props) {
    return(
        <section className='header'>
                ...
                <h2 className='score-item' style={{gridArea: '2 / 1 / 3 / 2'}}>Current Rolls: {props.rolls}</h2>
                <div className='score-item-container'>
                    <img className='score-icon' src={crown} alt="crown icon" />
                    <h2 className='score-item' style={{gridArea: '1 / 2 / 2 / 3'}}>Best Time Score: {props.bestTime}s</h2>
                    <img className='score-icon' src={crown} alt="crown icon" />
                </div>
                <h2 className='score-item' style={{gridArea: '2 / 2 / 3 / 3'}}>Current Time: {props.time}s</h2>
        </section>
    )
}
